...
// - Wittummm
// fuseLength = How long until the flashbang goes off
// One time use
    ...
    public void Explode()
    {
        ...
        if (MainCamera.instance != null)
        {
            ...
            if (vector.sqrMagnitude < 1024f)
            {
                ...
                if (num > -0.25f) // if facing near the direction of flashbang
                {
                    float magnitude = vector.magnitude; // Distance between camera and flashbang
        ...
        AlertTool.alert(base.transform.position, 32f); // Creates a distraction
